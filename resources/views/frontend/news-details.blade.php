            ...
            <div class="col-md-8">
                            ...
                            <div class="ml-3">
                                <div class="btn-group" role="group">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a class="dropdown-item" href="{{ route('news.export', ['slug' => $news->slug, 'format' => 'pdf']) }}">
                                            <i class="fas fa-file-pdf text-danger"></i> Export as PDF
                                        </a>
                                        <a class="dropdown-item" href="{{ route('news.export', ['slug' => $news->slug, 'format' => 'xls']) }}">
                                            <i class="fas fa-file-excel text-success"></i> Export as Excel (XLS)
                                        </a>
                                        <a class="dropdown-item" href="{{ route('news.export', ['slug' => $news->slug, 'format' => 'xlsx']) }}">
                                            <i class="fas fa-file-excel text-success"></i> Export as Excel (XLSX)
                                        </a>
                                        <a class="dropdown-item" href="{{ route('news.export', ['slug' => $news->slug, 'format' => 'xml']) }}">
                                            <i class="fas fa-file-code text-info"></i> Export as XML
                                        </a>
                                        <a class="dropdown-item" href="{{ route('news.export', ['slug' => $news->slug, 'format' => 'json']) }}">
                                            <i class="fas fa-file-code text-warning"></i> Export as JSON
                                        </a>
                                        <a class="dropdown-item" href="{{ route('news.export', ['slug' => $news->slug, 'format' => 'txt']) }}">
                                            <i class="fas fa-file-alt text-secondary"></i> Export as Text
                                        </a>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="wrap__profile">
                    <div class="wrap__profile-author">
                        <figure>
                            <img style="width: 200px;height: 200px;object-fit: cover;" src="{{ asset($news->auther->image) }}" alt="" class="img-fluid rounded-circle" onerror="this.onerror=null; this.src='{{ asset('frontend/assets/images/placeholder.webp') }}';">
                        </figure>
                ...
                <div class="small_add_banner mb-5 pb-4">
                    <div class="small_add_banner_img">
                        <a href="{{ $ad->view_page_ad_url }}">
                            <img src="{{ asset($ad->view_page_ad) }}" alt="adds" onerror="this.onerror=null; this.src='{{ asset('frontend/assets/images/placeholder.webp') }}';">
                        </a>
                    </div>
                </div>
                @endif
