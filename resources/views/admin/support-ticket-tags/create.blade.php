...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1>{{ __('Create Support Ticket Tag') }}</h1>
        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                <form action="{{ route('admin.support-ticket-tags.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <input type="color" name="color" class="form-control" value="{{ old('color', '#6c757d') }}" style="height: 50px;">
                            </div>
                            <div class="col-md-6">
                                <input type="text" name="color_hex" class="form-control" value="{{ old('color', '#6c757d') }}" placeholder="#6c757d" pattern="^#[a-fA-F0-9]{6}$">
