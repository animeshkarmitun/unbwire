...
<head>
  ...
  <title>Login &mdash; UNBNEWS</title>
  ...
  <!-- CSS Libraries -->
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-social/5.1.1/bootstrap-social.min.css" referrerpolicy="no-referrer" />
...
<body>
        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            <div class="login-brand">
              <img src="{{ asset('frontend/assets/images/logo1.png') }}" alt="logo" width="100" class="shadow-light">
            </div>
            ...
            <div class="simple-footer">
              {{ __('admin.Copyright') }} &copy; {{ __('admin.unbnews 2025') }}
            </div>
          </div>
        </div>
      </div>
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery.nicescroll/3.7.6/jquery.nicescroll.min.js" referrerpolicy="no-referrer"></script>
