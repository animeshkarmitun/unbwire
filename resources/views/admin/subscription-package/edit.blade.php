...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1>{{ __('admin.Edit Subscription Package') }}</h1>
        </div>

        <div class="card card-primary">
            <div class="card-header">
                <h4>{{ __('admin.Edit Package') }}</h4>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.subscription-package.update', $package->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" name="access_ap_photo" value="1" class="custom-control-input" id="access_ap_photo" {{ old('access_ap_photo', $package->access_ap_photo) ? 'checked' : '' }}>
